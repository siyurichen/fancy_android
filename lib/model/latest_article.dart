...
part 'latest_article.g.dart';


@JsonSerializable()
class LatestArticle extends Object {
  ...
  LatestArticle(this.data,this.errorCode,this.errorMsg,);

  factory LatestArticle.fromJson(Map<String, dynamic> srcJson) => _$LatestArticleFromJson(srcJson);

  Map<String, dynamic> toJson() => _$LatestArticleToJson(this);
